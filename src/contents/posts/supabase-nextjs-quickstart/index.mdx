...
[こちら](https://raw.githubusercontent.com/supabase/supabase/master/examples/react-user-management/src/index.css)のファイルで`styles/globals.css`を上書きしてください。
...
フロントをNext.jsで開発する際に、バックエンドのデータベース選びは、GraphQLベースであったり、NoSQL、CMSなど使いやすいサービスが豊富でどれがいいのかすごく悩みます。
